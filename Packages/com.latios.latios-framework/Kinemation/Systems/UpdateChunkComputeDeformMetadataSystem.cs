...
namespace Latios.Kinemation.Systems
{
    ...
    public partial class UpdateChunkComputeDeformMetadataSystem : SubSystem
    {
        ...
        {
            m_query = Fluent.WithAll<MeshSkinningBlobReference>(true).WithAll<ChunkComputeDeformMemoryMetadata>(false, true).Build();
        }
        ...
        {
            [ReadOnly] public ComponentTypeHandle<MeshSkinningBlobReference> blobHandle;
            ...
            public void Execute(ArchetypeChunk batchInChunk, int batchIndex)
            {
                ...
                {
                    int c       = blobs[i].blob.Value.verticesToSkin.Length;
